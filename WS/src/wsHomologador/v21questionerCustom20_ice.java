...
public class v21questionerCustom20_ice {
 ...
 //       String _password_usuario_secundario="";
        ...
        if (_os.equals("win")) {
        	_ruta_xmls_sin_firma=_path+_win+"data"+_win+_ruc_param+_win+"02_xmls_sin_firma_ice"+_win;
        }
     
        if (_os.equals("linux")) {
        	_ruta_xmls_sin_firma=_path+_lin+"data"+_lin+_ruc_param+_lin+"02_xmls_sin_firma_ice"+_lin;
        }
        misParametros.set_ruta_xml_sin_firma(_ruta_xmls_sin_firma);
		
        // armar la ruta para los _ruta_xmls_con_firma
        if (_os.equals("win")) {
        	_ruta_xmls_con_firma=_path+_win+"data"+_win+_ruc_param+_win+"03_xmls_con_firma_ice"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_xmls_con_firma=_path+_lin+"data"+_lin+_ruc_param+_lin+"03_xmls_con_firma_ice"+_lin;
        }
        misParametros.set_ruta_xml_con_firma(_ruta_xmls_con_firma);
		
        // armar la ruta para los _ruta_respuestas
        if (_os.equals("win")) {
        	_ruta_respuestas=_path+_win+"data"+_win+_ruc_param+_win+"04_respuestas_ice"+_win;
        }
        if (_os.equals("linux")) {
        	_ruta_respuestas=_path+_lin+"data"+_lin+_ruc_param+_lin+"04_respuestas_ice"+_lin;
        }
