...
public class v21questionerND_Pruebas {
 ...
 //       String _password_usuario_secundario="";
		...
		DataHandler dhandler_ley = new DataHandler(ds_ley);
	 	...
	 	v21crearXMLcustom20ND.c_XML(dhandler_det, dhandler_cab, dhandler_aca, dhandler_ley, dhandler_rel, $FILE_NAME, misParametros,$FIRMA_CONECTA);
